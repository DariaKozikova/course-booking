...
// RestaurantUserBookingPage.jsx
// Static (non-interactive) restaurant user booking page — orange theme version
      ...
      <header className="max-w-5xl mx-auto mb-6">
        <div className="flex items-center justify-between p-4 rounded-2xl shadow-sm bg-white">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-xl font-semibold text-orange-900">Ristorante Roma</h1>
              <p className="text-sm text-orange-700">Ласкаво просимо, Гість</p>
            </div>
          </div>
